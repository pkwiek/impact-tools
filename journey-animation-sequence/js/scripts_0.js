...
mapboxgl.accessToken =
  "pk.eyJ1IjoicGt3aWVrIiwiYSI6ImNsbGZjamgzaTBnbmszZXBmMmdpM3Y2aXMifQ.rfHdquK-gYFKDXYNZkmKIw";
...
const playAnimations = async (trackGeojson) => {
  return new Promise(async (resolve) => {
    ...
    var endLngLat = {
      lng: trackGeojson.geometry.coordinates[trackGeojson.geometry.coordinates.length - 1][0],
      lat: trackGeojson.geometry.coordinates[trackGeojson.geometry.coordinates.length - 1][1],
    };

    // fly with default options to null island
    map.easeTo({
    center: [endLngLat.lng, endLngLat.lat],
    pitch: 30,
    bearing: 0,
    zoom: 12,
    });
